...
export default function HeroSection({ business }) {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--template-background-light)] to-white pt-20 mt-16 lg:mt-20 overflow-hidden"
    >
      {/* Background Image */}
