        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20 w-full">
            ...
            <div className="lg:hidden flex items-center space-x-2 flex-shrink-0">
              ...
              {/* Hamburger menu */}
              <button
                className="p-2 rounded-lg text-gray-700 hover:text-[var(--template-accent)] hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--template-accent)]"
